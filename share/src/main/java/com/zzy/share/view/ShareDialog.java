...
public class ShareDialog extends DialogFragment implements IShareView, View.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        RecyclerView rv = dialog.findViewById(R.id.recycler_view_share);
        ...
        assert arr != null;
        rv.setLayoutManager(new GridLayoutManager(context, count == 0 ? 4 : count));
        rv.setAdapter(new ShareAdapter(arr));
