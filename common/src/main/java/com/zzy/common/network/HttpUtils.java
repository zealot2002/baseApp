...
//
    ...
    /* request */
    public void req(String actionName, JSONObject body, final HInterface.DataCallback callback,
        ...
        RequestCtx.Builder builder = new RequestCtx.Builder(HttpConstants.SERVER_ADDRESS + actionName)
